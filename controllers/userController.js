...
const getUsers = asyncHandler(async (req, res) => {
  try {
        ...
        let toursPageLimit = 10
        const page = treq.query.page * 1 || 1
        const limit = treq.query.limit * 1 || toursPageLimit
        const skip = (page - 1) * limit
        const userList = await userModels.find({}).skip(skip).limit(limit)
